...
%
% outputs are:
% descrambled - the descrambled coefficients

function [descrambled] = scrambledXoR_Inter_Backward( dct_imgCache_quant, seed)
...
if(method==1)
    descrambled = izigzag(final, sqrt(16), sqrt(16));
else
    descrambled = final;
end
